...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/data-business.js":[function(require,module,exports) {
"use strict";
...
function getCharacterById(id) {
  return _axios.default.get("https://rickandmortyapi.com/api/character/".concat(id)).then(function (response) {
...
function getLocations() {
  return _axios.default.get("https://rickandmortyapi.com/api/location/").then(function (response) {
    return response.data.results;
  });
}

...
exports.mapTransferVisualModelToApi = exports.mapTransferApiToVisualModel = exports.mapAccountApiToVisualModel = void 0;
var mapTransferApiToVisualModel = function mapTransferApiToVisualModel(transfer) {
  return {
    selectAccount: transfer.selectAccount,
    iban: transfer.iban,
    name: transfer.name,
    amount: "".concat(transfer.amount, " \u20AC"),
...
exports.mapTransferApiToVisualModel = mapTransferApiToVisualModel;
var mapTransferVisualModelToApi = function mapTransferVisualModelToApi(transfer) {
  return {
    selectAccount: transfer.selectAccount,
    iban: transfer.iban,
    name: transfer.name,
...
/*iban: ' ',
    ...
    year: '',
    email: '', */
exports.mapTransferVisualModelToApi = mapTransferVisualModelToApi;
var mapAccountApiToVisualModel = function mapAccountApiToVisualModel(account) {
  return {
...
var dayValidator = function dayValidator(_ref) {
  ...
  var succeeded = intValue >= 1 && intValue <= 31;
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Introduce un número válido para el día (entre 1 y 31)',
    type: ''
  };
};
...
var monthValidator = function monthValidator(_ref2) {
  var value = _ref2.value;
  var intValue = parseInt(value);
  var succeeded = intValue >= 1 && intValue <= 12;
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Introduce un número válido para el mes (entre 1 y 12)',
    type: ''
  };
};
...
var yearValidator = function yearValidator(_ref3) {
  ...
  var succeeded = intValue >= currentYear;
  return {
    succeeded: succeeded,
    message: succeeded ? '' : 'Introduce un número válido para el año (igual o mayor al año actual)',
    type: ''
  };
};
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-positive-number-validator":"../node_modules/@lemoncode/fonk-positive-number-validator/dist/@lemoncode/fonk-positive-number-validator.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js","./transfer.custom.validation":"pages/transfer/transfer.custom.validation.js"}],"../node_modules/has-symbols/shams.js":[function(require,module,exports) {
'use strict';
...
},{"qs":"../node_modules/qs/lib/index.js"}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";

var _transfer = require("./transfer.api");
var _transfer2 = require("./transfer.mappers");
var _transfer3 = require("./transfer.helpers");
var _helpers = require("../../common/helpers");
var _transfer4 = require("./transfer.validation");
...
if (isEditMode) {
  (0, _transfer.getAccounts)().then(function (accounts) {
    (0, _transfer3.setAccountOptions)(accounts, params.id);
    transfer = _objectSpread(_objectSpread({}, transfer), {}, {
      selectAccount: params.id
    });
  });
} else {
...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfer4.formValidation.validateField('iban', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfer4.formValidation.validateField('name', transfer.name).then(function (result) {
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _transfer4.formValidation.validateField('name', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  // Validation:
  _transfer4.formValidation.validateField('day', transfer.day).then(function (result) {
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  // Validation:
  _transfer4.formValidation.validateField('month', transfer.month).then(function (result) {
...
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  // Validation:
  _transfer4.formValidation.validateField('year', transfer.year).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  // Validation:
  _transfer4.formValidation.validateField('email', transfer.email).then(function (result) {
...
},{"./transfer.api":"pages/transfer/transfer.api.js","./transfer.mappers":"pages/transfer/transfer.mappers.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../common/helpers":"common/helpers/index.js","./transfer.validation":"pages/transfer/transfer.validation.js","../../core/router/history":"core/router/history.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];

...
exports.getMovements = exports.getAccounts = void 0;
...
var getAccounts = function getAccounts(id) {
  ...
  return _axios.default.get(accountUrl, {
    params: {
      id: id
    }
  }).then(function (_ref2) {
...
exports.mapMovementsListApiToVisualModel = exports.mapAccountApiToVisualModel = void 0;
// Función para mapear una lista de movimientos de la API a un modelo visual:

var mapMovementsListApiToVisualModel = function mapMovementsListApiToVisualModel(movementsList) {
  ...
  return movementsList.map(function (movement) {
    return mapMovementsApiToVisualModel(movement);
  });
};

// Función para mapear un movimiento de la API a un modelo visual.
exports.mapMovementsListApiToVisualModel = mapMovementsListApiToVisualModel;
var mapMovementsApiToVisualModel = function mapMovementsApiToVisualModel(movement) {
  ...
  return {
    ...
    // Se realiza la interpolación y agregamos el símbolo de euro al importe.
    balance: "".concat(movement.balance, " \u20AC") // Se realiza la interpolación y agregamos el símbolo de euro al saldo.
  };
};
...
if (isEditMode) {
  ...
  (0, _movements.getMovements)(accountId).then(function (movementList) {
    // Mapeamos la respuesta de la API a un formato visual utilizando 'mapMovementsListApiToVisualModel'.
    var movements = (0, _movements3.mapMovementsListApiToVisualModel)(movementList);
  ...
  (0, _movements.getMovements)().then(function (movementList) {
    // Mapeamos la respuesta de la API a un formato visual utilizando 'mapMovementsListApiToVisualModel'.
    var movements = (0, _movements3.mapMovementsListApiToVisualModel)(movementList);
    // Agregamos las filas de movimientos a la página utilizando 'addMovementRows'.
    (0, _movements2.addMovementRows)(movements);
...
;
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js","../../core/router/history":"core/router/history.js","../../common/helpers":"common/helpers/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {

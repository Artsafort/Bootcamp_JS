...
import { mapAccountFromApiToViewModel, mapAccountFromtViewModelToApi } from './account.mappers';

const params = history.getParams();
const isEditMode = Boolean(params.id);

if (isEditMode) {getAccount(params.id).then(apiAccount => {
...
const onSave = () => {
    const apiAccount = mapAccountFromtViewModelToApi(account);

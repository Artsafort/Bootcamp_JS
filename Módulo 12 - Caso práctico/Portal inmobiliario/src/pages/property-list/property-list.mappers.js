export const mapPropertyListFromApiToViewModel = (propertyList) => {
    return propertyList.map((property) => mapPropertyFromApiToVisualModel(property));
 };

const mapPropertyFromApiToVisualModel = property => {
    return {
        id: property.id,
        title: property.title,
        rooms: `${property.rooms} ${getRoomWord(property.rooms)}`,
        squareMeter: `${property.squareMeter}m2`,
        notes: property.notes ? `${property.notes.substring (0 , 240)}...` : '',

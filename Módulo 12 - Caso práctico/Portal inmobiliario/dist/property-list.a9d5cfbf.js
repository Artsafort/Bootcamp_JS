...
var mapPropertyListFromApiToViewModel = function mapPropertyListFromApiToViewModel(propertyList) {
  return propertyList.map(function (property) {
    return mapPropertyFromApiToVisualModel(property);
  });
};
exports.mapPropertyListFromApiToViewModel = mapPropertyListFromApiToViewModel;
var mapPropertyFromApiToVisualModel = function mapPropertyFromApiToVisualModel(property) {
  return {
    id: property.id,
    title: property.title,
    rooms: "".concat(property.rooms, " ").concat(getRoomWord(property.rooms)),
    squareMeter: "".concat(property.squareMeter, "m2"),
    notes: property.notes ? "".concat(property.notes.substring(0, 240), "...") : '',
    price: property.price ? "".concat(property.price.toLocaleString(), " \u20AC") : '',

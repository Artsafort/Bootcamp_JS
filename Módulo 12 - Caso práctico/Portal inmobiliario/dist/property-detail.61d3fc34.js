...
var getPropertyDetail = function getPropertyDetail(id) {
...
var getEquipmentList = function getEquipmentList() {
  return _axios.default.get(equipmentListUrl).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
var mapPropertyListFromApiToViewModel = function mapPropertyListFromApiToViewModel(newProperty, equipmentList) {
  return {
    ...
    price: "".concat(newProperty.price.toLocaleString(), " \u20AC"),
    title: newProperty.title,
    city: newProperty.city,
    rooms: "".concat(newProperty.rooms, " ").concat(getRoomWord(newProperty.rooms)),
    squareMeter: "".concat(newProperty.squareMeter, "m2"),
    bathrooms: "".concat(newProperty.bathrooms, " ").concat(getBathroomWord(newProperty.bathrooms)),
...
exports.mapPropertyListFromApiToViewModel = mapPropertyListFromApiToViewModel;
...
function transformEquipment(newProperty, equipmentList) {
  ...
  transformed = newProperty.equipmentIds.map(function (obj) {
    var found = equipmentList.find(function (element) {
...
},{"qs":"../node_modules/qs/lib/index.js"}],"pages/property-detail/property-detail.helpers.js":[function(require,module,exports) {
"use strict";
...
var _propertyDetail2 = require("../property-detail/property-detail.mappers");
...
if (isId) {
  Promise.all([(0, _propertyDetail.getPropertyDetail)(params.id), (0, _propertyDetail.getEquipmentList)()]).then(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      apiPropertyDet = _ref2[0],
      equipmentList = _ref2[1];
    var propertySeenDetail = (0, _propertyDetail2.mapPropertyListFromApiToViewModel)(apiPropertyDet, equipmentList);
    (0, _propertyDetail3.setPropertyValues)(propertySeenDetail);
  });
}
;

...
exports.insertProperty = exports.getSaleTypeList = exports.getProvinceList = exports.getEquipmentList = void 0;
...
var salesTypesUrl = "".concat("http://localhost:3000/api", "/saleTypes");
var getSaleTypeList = function getSaleTypeList() {
  return _axios.default.get(salesTypesUrl).then(function (response) {
    return response.data;
  });
};
...
var insertProperty = function insertProperty(newProperty) {
  return _axios.default.post(url, newProperty).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
exports.insertProperty = insertProperty;
},{"axios":"../node_modules/axios/index.js"}],"../node_modules/has-symbols/shams.js":[function(require,module,exports) {
'use strict';
...
},{"qs":"../node_modules/qs/lib/index.js"}],"pages/upload-property/upload-property.helpers.js":[function(require,module,exports) {
"use strict";
...
var removeElement = function removeElement(value, obj, id) {
  return _objectSpread(_objectSpread({}, obj), {}, _defineProperty({}, id, obj[id].filter(function (el) {
    return el !== value;
  })));
...
exports.mapPropertyListFromViewModelToApi = void 0;
var mapPropertyListFromViewModelToApi = function mapPropertyListFromViewModelToApi(newProperty) {
  return {
...
// equipments: '', 
// images: '',
exports.mapPropertyListFromViewModelToApi = mapPropertyListFromViewModelToApi;
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"../node_modules/@lemoncode/fonk-positive-number-validator/dist/@lemoncode/fonk-positive-number-validator.esm.js":[function(require,module,exports) {
"use strict";
...
var _uploadPropertyApi = require("./upload-property.api.js");
var _history = require("../../core/router/history");
var _uploadPropertyHelpers = require("./upload-property.helpers.js");
var _uploadProperty = require("./upload-property.mappers");
var _uploadPropertyValidations = require("./upload-property.validations.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
(0, _helpers.onUpdateField)('title', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('title', newProperty.title).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('email', newProperty.email).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('notes', newProperty.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('price', newProperty.price).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('phone', newProperty.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('address', newProperty.address).then(function (result) {
...
(0, _helpers.onUpdateField)('city', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('city', newProperty.city).then(function (result) {
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('province', newProperty.province).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('locationUrl', newProperty.locationUrl).then(function (result) {
...
(0, _helpers.onUpdateField)('images', function (event) {
  ...
  _uploadPropertyValidations.formValidation.validateField('images', newProperty.images).then(function (result) {
...
(0, _helpers.onAddFile)('add-image', function (value) {
  (0, _uploadPropertyHelpers.onAddImage)(value);
...
},{"../../common/helpers":"common/helpers/index.js","./upload-property.api.js":"pages/upload-property/upload-property.api.js","../../core/router/history":"core/router/history.js","./upload-property.helpers.js":"pages/upload-property/upload-property.helpers.js","./upload-property.mappers":"pages/upload-property/upload-property.mappers.js","./upload-property.validations.js":"pages/upload-property/upload-property.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
